...
export default function BannerCard({ title, description, image, page }) {
  return (
    <div className="xl:grid xl:grid-cols-2 items-center  p-6 ">
      ...
      <div className="text-center space-y-4 xl:text-left  xl:ml-28 text-white ">
        <h1 className="font-bold text-3xl xl:text-6xl ">{title}</h1>
        <p className="font-light xl:text-lg xl:w-2/3">{description}</p>
        <Link href={page}>
